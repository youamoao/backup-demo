package com.backup.demo.constants;
...
public class BackupConstants {
	...
	/** 备份目录名称 */
	public static final String BACKUP_FOLDER_NAME = "_datasource_backup";
	/** 备份目录 */
	...
	/** 默认备份文件名 */
	public static final String BACKUP_FILE_NAME = "datasource" + SQL_EXT;
	/** 默认备份还原目录名称 */
